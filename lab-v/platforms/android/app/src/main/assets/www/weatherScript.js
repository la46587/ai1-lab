...
document.weatherApp = new WeatherApp("200c94096875a8978901031ddbc17bfd", "#weather-results-container");
...
document.querySelector("#locationInput").addEventListener("keypress", function(e) {
    if (e.key === "Enter") {
        const query = document.querySelector("#locationInput").value;
        document.weatherApp.getWeather(query);
    }
